...
/**
 * Return true, if the value is a valid car identification number (VIN).
 *
 * Works with all kind of text inputs.
 *
 * @example <input type="text" size="20" name="CarID" class="{required:true,vinUS:true}" />
 * @desc Declares a required input element whose value must be a valid car identification number.
 *
...
$.validator.addMethod( "vinUS", function( v ) {
	...
	return false;
}, "The specified car identification number (VIN) is invalid." );
